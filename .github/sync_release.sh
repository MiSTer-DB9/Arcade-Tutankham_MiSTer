...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Tutankham_MiSTer.git"
CORE_NAME=(Arcade-Tutankham)
...
UPSTREAM_CORE_NAME=(Tutankham)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Tutankham.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Tutankham.rbf)
